...
class TestSessionContext(object):
    def test_enter_yields_session(self, commands, start_cmd):
        start_cmd.send.return_value = '1234'

        context = warthog.client.SessionContext(SCHEME_HOST, 'user', 'password', commands)
    ...
    def test_exit_closes_previous_session(self, commands, start_cmd, end_cmd):
        start_cmd.send.return_value = '1234'
    ...
    def test_exception_in_context_propagated(self, commands, start_cmd):
        start_cmd.send.return_value = '1234'
        context = warthog.client.SessionContext(SCHEME_HOST, 'user', 'password', commands)
